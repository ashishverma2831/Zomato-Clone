    ...
    <>
      <header className='bg-[url("https://b.zmtcdn.com/web_assets/81f3ff974d82520780078ba1cfbd453a1583259680.png")] h-[420px] bg-no-repeat bg-center bg-cover'>
        ...
        <div className=' flex justify-center items-center bg-red-400'>
          <div className=' w-full  md:max-w-screen-md mx-auto p-5 my-10 bg-blue-400'>
            ...
            <div className='flex justify-center items-center gap-4'>
              <input type='text' placeholder='Search for restaurant, cuisine or a dish' className='w-96 h-14 px-4 text-xl font-normal placeholder-gray-500 border-0 focus:outline-none focus:border-0 focus:border-green-500 rounded-lg' />
              <button className='bg-white text-red-400 font-normal text-xl px-6 py-2 rounded-lg'>Search</button>
              </div>
          </div>
        </div>
      </header>
